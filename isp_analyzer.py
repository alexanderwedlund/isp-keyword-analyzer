...
st.set_page_config(page_title="ISP Analyzer", layout="wide")
...
with col_main:
    ...
    if current_isp and st.session_state.current_keyword:
        ...
        2. **Select a keyword**: Choose one of the keywords from the sidebar.
        3. **Classify sentences**: Mark each sentence as either:
           - **Actionable Advice (AA)**
           - **Other Information (OI)**
        4. **Save your progress**: You can save your session anytime.
        5. **Export results**: Export to Excel matching the original study format.
        """)
